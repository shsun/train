...
public class XJedisLock {
     ...
     */
    public XJedisLock(Jedis jedis, String lockKey) {
     ...
     */
    public XJedisLock(Jedis jedis, String lockKey, int acquireTimeoutMillis) {
     ...
     */
    public XJedisLock(Jedis jedis, String lockKey, int acquireTimeoutMillis, int expiryTimeMillis) {
     ...
     */
    public XJedisLock(Jedis jedis, String lockKey, int acquireTimeoutMillis, int expiryTimeMillis, UUID uuid) {
        this.jedis = jedis;
