...
public class XSQLServerDialect extends XDialect {
	...
	public String getLimitString(String querySelect, int offset, String offsetPlaceholder, int limit,
		...
		// throw new
		// UnsupportedOperationException(" sql server not support variable
		// limit");
		// }

		/*
		 * select top limit * FROM ( SELECT top 10 ROW_NUMBER() OVER (ORDER BY
		 * ReportID) AS RowNo FROM TABLE ) AS A WHERE RowNo > " + pageIndex*10
		 */
