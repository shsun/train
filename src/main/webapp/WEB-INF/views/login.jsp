                    ...
                    <div class="form-bottom">
                        <form class="form-horizontal login-form" role="form" novalidate name="myForm">
                            <div class="form-group">
                                ...
                                <input type="text" required ng-model="loginForm.username" name="form-username" placeholder="用户名..." class="form-username form-control"
                                       id="form-username">
                            </div>
                            <div class="form-group">
                                <label class="sr-only" for="form-password">Password</label>
                                <input type="password" required ng-model="loginForm.password" name="form-password" placeholder="密码..." class="form-password form-control"
                                       id="form-password">
                            </div>
...
<script type="text/javascript">
    ...
    myApp.controller('LoginCtrl', function ($scope, $http, $location, toaster) {
        ...
        $scope.login = function () {
            var url = '${ctx}/sys/login';
            // url = 'http://localhost:8080/xyz/login';
            $scope.promise = $http.post(url, $scope.loginForm).success(function (data) {
